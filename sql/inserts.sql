...
('Bela', 'Cão', 'Poodle', 'Pequeno', 5.2, 2, 'Boa', 'Disponível', 3),
('Thor', 'Cão', 'Bulldog', 'Médio', 20.0, 4, 'Boa', 'Disponível', 3),
('Mel', 'Gato', 'Persa', 'Pequeno', 3.0, 1, 'Regular', 'Disponível', 4),
('Maggie', 'Cão', 'Golden Retriever', 'Grande', 28.0, 3, 'Boa', 'Disponível', 1),
('Tom', 'Gato', 'SRD', 'Pequeno', 4.0, 2, 'Boa', 'Disponível', 2),
('Max', 'Cão', 'Vira-lata', 'Médio', 15.0, 5, 'Boa', 'Adotado', 2),
('Nina', 'Gato', 'Angorá', 'Pequeno', 4.2, 3, 'Boa', 'Adotado', 3),
...
('2023-10-01', 'Concluída', 10, 4),
('2023-10-05', 'Concluída', 11, 5);

-- Populando a tabela Devolucao
...
-- Populando a tabela Procedimento
...
('Esterilização', 'Castração preventiva', '2023-06-05', '2023-06-05', 5),
('Esterilização', 'Castração preventiva', '2023-07-10', '2023-07-10', 6),
('Esterilização', 'Castração preventiva', '2023-08-15', '2023-08-15', 9);
